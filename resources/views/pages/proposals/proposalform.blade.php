                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="fullname" name="fullname" placeholder="Your Full Name"
                                        value="{{isset($isnewprop) ? auth()->user()->name: (isset($prop) ? $prop->applicant->name :'') }}" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="email" name="email" placeholder="Your Email"
                                        value="{{isset($isnewprop) ? auth()->user()->email: (isset($prop) ? $prop->applicant->email :'') }}" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="pfnofk" name="pfnofk" placeholder="Your PF Number"
                                        value="{{isset($isnewprop) ? auth()->user()->pfno: (isset($prop) ? $prop->applicant->pfno :'') }}" class="form-control" readonly>
                                </div>
                            </div>
                            ...
                            $(document).ready(function () {
                                ...
                                function populateworkplanitems(data) {
                                    ...
                                    if (data.length > 0) {
                                        ...
                                        var row = '<tr><td colspan="5" class="text-center">No WorkPlan Items found</td></tr>';
                                        tbody.append(row);
                                    }
                                }
