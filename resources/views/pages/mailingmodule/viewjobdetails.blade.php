...
@auth
  @if (isset($job))
    ...
    <form method="POST" id="jobdetailsform" enctype="multipart/form-data" class="form-horizontal">
      ...
      <div class="row form-groupn mb-2">
      <div class="col col-md-2">
      <label class="form-control-label">Attempts</label>
      </div>
      <div class="col-12 col-md-10">
      <input type="text" value="{{ $job->attempts }}" class="form-control" readonly>
      </div>
      </div>
      ...
      <div class="col-12 col-md-10">
      <textarea type="text" class="form-control" rows="15" readonly>{{ $job->payload }}</textarea>
      </div>
      </div>
