            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" id="nav-researchprogress-tab" data-bs-toggle="tab"
                        data-bs-target="#panel-researchprogress" type="button" role="tab" aria-controls="panel-researchprogress"
                        aria-selected="false">Progress</button>
                    <button class="nav-link" id="nav-funding-tab" data-bs-toggle="tab"
                        data-bs-target="#panel-funding" type="button" role="tab" aria-controls="panel-funding"
                        aria-selected="false">Funding</button>
                </div>
            </nav>
